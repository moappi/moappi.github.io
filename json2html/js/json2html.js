...
(function() {
	...
	root.json2html = {
        ...
        "component":{
            ...
            //OR add(components) where component is obj with name:template property eg {"name":template,...}
				...
				$.json2html = function(obj, template, options) {
					...
					switch(_options.output){
						...
						case "html":
							...
							return((json2html.render(obj, template, _options)).html);
						break;
					}
				};
